...
const TypographiesByType = ({ as, isHeavy }: TypographiesByTypeProps) => (
  <div>
    <Typography {...{ as, isHeavy }} type="h1">
      Hello World!
    </Typography>
    <Typography {...{ as, isHeavy }} type="h2">
      Hello World!
    </Typography>
    <Typography {...{ as, isHeavy }} type="h3">
      Hello World!
    </Typography>
    <Typography {...{ as, isHeavy }} type="h4">
      Hello World!
    </Typography>
    <Typography {...{ as, isHeavy }} type="h5">
      Hello World!
    </Typography>
    <Typography {...{ as, isHeavy }} type="h6">
      Hello World!
    </Typography>
    <Typography {...{ as, isHeavy }} type="body-sm">
      Hello World!
    </Typography>
    <Typography {...{ as, isHeavy }} type="body-md">
      Hello World!
    </Typography>
    <Typography {...{ as, isHeavy }} type="body-lg">
      Hello World!
    </Typography>
  </div>
);
